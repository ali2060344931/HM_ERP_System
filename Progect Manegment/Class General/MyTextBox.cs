...
namespace MyClass
{
    public partial class MyTextBox : TextBox
    {
        ...
        {
            /*
            ContextMenuStrip cmMaine = new ContextMenuStrip();
            cmMaine.Font = new System.Drawing.Font("tahoma", 9);
            cmMaine.Items.Add("کپی");
            cmMaine.Items.Add("الصاق");
            cmMaine.Items.Add("-");
            cmMaine.Items.Add("انتخاب همه");
            cmMaine.Items.Add("حذف");

            cmMaine.Items[0].Click += new EventHandler(Copy_Clice);
            cmMaine.Items[1].Click += new EventHandler(Paste_Clice);

            cmMaine.Items[3].Click += new EventHandler(Select_Clice);
            cmMaine.Items[4].Click += new EventHandler(Delete_Clice);
