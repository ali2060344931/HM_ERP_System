...
{
    public partial class frmProvinces : frmAddItems, IUpdatableForms
    {
        private IUpdatableForms _updatableForms;
        public int ListId = 0;

        public frmProvinces(IUpdatableForms updatableForms)
        {
            InitializeComponent();
            ...
            try
            {
                ...
                using (var db = new DBcontextModel())
                {
                    ...
                    if (ListId == 0)
                    {
                        ...
                        if (cont > 0)
                        {
                            PublicClass.ErrorMesseg(ResourceCode.T001); return;
                        }
                    }
                    else
                    {
                    ...
                    var userRepo = new Repository<Provinces>(db);
        ...
        private void frmProvinces_KeyDown(object sender, KeyEventArgs e)
        {
